                                ...
                                <tbody>
                                    @foreach ($classes as $key => $class)
                                        <tr>
                                            ...
                                            <td class="align-middle bg-transparent border-bottom">{{ $class->homework_name }}</td>
                                            <td class="align-middle bg-transparent border-bottom">{{ count($class->questions) }}</td>
                                            <td class="align-middle bg-transparent border-bottom">{{ $class->time }}</td>
                                            <td class="align-middle bg-transparent border-bottom">{{ $class->end_time }}</td>
